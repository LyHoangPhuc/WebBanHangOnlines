...
using WebBanHangOnlines.Models.EF;
using WebBanHangOnlines.Models;

namespace WebBanHangOnlines.Controllers
{
    [Authorize]
...
/*                    var strSanPham = "";
                    ...
                    contentCustomer = contentCustomer.Replace("{{ThanhTien}}", WebBanHangOnlines.Common.Common.FormatNumber(thanhtien, 0));
                    contentCustomer = contentCustomer.Replace("{{TongTien}}", WebBanHangOnlines.Common.Common.FormatNumber(TongTien, 0));
                    WebBanHangOnlines.Common.Common.SendMail("ShopOnline", "Đơn hàng #" + order.Code, contentCustomer.ToString(), req.Email);
                    ...
                    contentAdmin = contentAdmin.Replace("{{ThanhTien}}", WebBanHangOnlines.Common.Common.FormatNumber(thanhtien, 0));
                    contentAdmin = contentAdmin.Replace("{{TongTien}}", WebBanHangOnlines.Common.Common.FormatNumber(TongTien, 0));
